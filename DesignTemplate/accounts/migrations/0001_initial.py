    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tech_stack_tags', models.JSONField(blank=True, default=list, help_text='Technologies the user works with')),
                ('github_profile', models.URLField(blank=True, help_text='GitHub profile URL', null=True)),
